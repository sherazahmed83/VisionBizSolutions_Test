...
Created by Willam van Weelden on 18-03-2010
...
The default ShowHide mode is the one button method. You can turn this offf with the variable OneButtonMethod.

=== Setting up the script ===

First step is, of course, to add the script in the header section of your topic.
...
if(Browser == "Firefox" && FirefoxSupport == true)
{
