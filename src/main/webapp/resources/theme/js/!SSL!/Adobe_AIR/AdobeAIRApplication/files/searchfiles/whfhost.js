//	WebHelp 5.10.003
var gsNoTopics="%%%WH_CUR_LNG.TopicsNotFound%%%";
var gsLoadXmlFailed="%%%WH_CUR_LNG.JS_alert_LoadXmlFailed%%%";
var gsInitDatabaseFailed="%%%WH_CUR_LNG.JS_alert_InitDatabaseFailed%%%";
var gsNotAllDatabaseInited="%%%WH_CUR_LNG.JS_alert_NotAllDatabaseInited%%%";
var gsInvalidExpression_1="%%%WH_CUR_LNG.JS_alert_InvalidExpression_1%%%";
var gsInvalidExpression_2="%%%WH_CUR_LNG.JS_alert_InvalidExpression_2%%%";
var gsInvalidExpression_3="%%%WH_CUR_LNG.JS_alert_InvalidExpression_3%%%";
var gsInvalidExpression_4="%%%WH_CUR_LNG.JS_alert_InvalidExpression_4%%%";
var gsSearching="%%%WH_CUR_LNG.Searching%%%";
var gsTitle="%%%WH_CUR_LNG.Title%%%";
var gsRank="%%%WH_CUR_LNG.Rank%%%";
var gsCancel="%%%WH_CUR_LNG.Cancel%%%";
var gsCanceled="%%%WH_CUR_LNG.Canceled%%%";
