	...
	<div id="header">
		...
		<div id="navigation">
			<ul>
				...
				<li class="selected"><a
					href="${pageContext.request.contextPath}/faqs"><spring:message
					...
					<td width="720" valign="top" style="padding-right: 10px;">
						<div class="divrightmain">
							<h3 style="color: #003a75;">
								<spring:message code="label.faqs.page.header" />
							</h3>
							<div class="whyusmain">
								<div class="whyus" style="font-size: 10pt;">
									<!-- START -->
									<spring:message code="label.faqs.page.ques1" />
									<spring:message code="label.faqs.page.ans1" />
									<spring:message code="label.faqs.page.ques2" />
									<spring:message code="label.faqs.page.ans2" />
									<spring:message code="label.faqs.page.ques3" />
									<spring:message code="label.faqs.page.ans3" />
									<spring:message code="label.faqs.page.ques4" />
									<spring:message code="label.faqs.page.ans4" />
									<spring:message code="label.faqs.page.ques5" />
									<spring:message code="label.faqs.page.ans5" />
									<spring:message code="label.faqs.page.ques6" />
									<spring:message code="label.faqs.page.ans6" />
									<spring:message code="label.faqs.page.ques7" />
									<spring:message code="label.faqs.page.ans7" />
									<spring:message code="label.faqs.page.ques8" />
									<spring:message code="label.faqs.page.ans8" />
									<spring:message code="label.faqs.page.ques9" />
									<spring:message code="label.faqs.page.ans9" />
									<spring:message code="label.faqs.page.ans9.1" />
									<spring:message code="label.faqs.page.ques10" />
									<spring:message code="label.faqs.page.ans10" />
									<spring:message code="label.faqs.page.ques11" />
									<spring:message code="label.faqs.page.ans11" />
									<spring:message code="label.faqs.page.ques12" />
									<spring:message code="label.faqs.page.ans12" />
									<spring:message code="label.faqs.page.ques13" />
									<spring:message code="label.faqs.page.ans13" />
									<spring:message code="label.faqs.page.ques14" />
									<spring:message code="label.faqs.page.ans14" />
			 				...
			 				-->
									...
									<strong><a
										...
										href="${pageContext.request.contextPath}/contact"><spring:message
												code="label.data.security.page.link.to.contact.text2" /></a></strong><br />
									<!-- #enquiry -->
