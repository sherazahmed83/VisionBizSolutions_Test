					...
					<td width="720" valign="top" style="padding-right: 10px;">
						<div class="divrightmain">
							<h3 style="color: #003a75;">
								<spring:message code="label.forgotpasswordProcessed.page.header" />
							</h3>
							<div id="login-box" style="width: 400px;">
							<span
									style="text-align: left; font-size: 13pt; font-weight: bold; padding-bottom: 30px;"><spring:message
										code="label.forgotpasswordProcessed.page.subheader" /></span> <span>&nbsp;</span>
								<span><br /></span>
								<span><br /></span>
								<span
									style="text-align: left; font-size: 10pt; padding-bottom: 30px;"><spring:message
										code="label.forgotpasswordProcessed.page.para1" /></span> <span>&nbsp;</span>
								<span><br /></span>
								<span><br /></span>
								<span
									style="text-align: left; font-size: 10pt; padding-bottom: 30px;"><spring:message
										code="label.forgotpasswordProcessed.page.para2" /></span> <span>&nbsp;</span>
								<span><br /></span>
								<br /> <br /> <strong><span class="thankyou"><a
											href="${pageContext.request.contextPath}/" class="thankyou">Continue</a></span></strong>
							</div>
						</div>
					</td>
				</tr>
