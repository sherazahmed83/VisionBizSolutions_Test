				...
				<tr>
					...
					<td width="720" valign="top" style="padding-right: 10px;">
						<div class="divrightmain">
							<h2 style="color: #003a75;">
								<spring:message code="label.passwordUpdateSuccess.page.header" />
							</h2>
							<div class="whyusmain">
								...
								<span
									style="text-align: left; font-size: 13pt; font-weight: bold; padding-bottom: 30px;color: #003a75;"><spring:message
										code="label.passwordUpdateSuccess.page.subheader1" /></span> <span>&nbsp;</span>
								<span><br /></span>
									<spring:message code="label.passwordUpdateSuccess.page.para1" />
									<br /> <br /><p style="text-align: center;">  <strong><span class="thankyou"><a
											href="${pageContext.request.contextPath}/" class="thankyou">Continue</a></span></strong></p>
								</div>
							</div>
						</div>
					</td>
