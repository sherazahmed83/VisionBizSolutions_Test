					...
					<td width="720" valign="top" style="padding-right: 10px;">
						<div class="divrightmain">
							<h3 style="color: #003a75;">
								<spring:message code="label.accountcreated.page.header" />
							</h3>
							<div class="whyusmain">
								<div class="whyus" style="text-align: left;">
									<strong><spring:message code="label.accountcreated.page.para1" /></strong>
									<spring:message code="label.accountcreated.page.para2" />
