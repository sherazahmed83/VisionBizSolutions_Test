	...
	<div id="header">
		...
		<div id="navigation">
			<ul>
				...
				<li class="selected"><a
					href="${pageContext.request.contextPath}/datasecurity"><spring:message
					...
					<td width="720" valign="top" style="padding-right: 10px;">
						<div class="divrightmain">
							<h3 style="color: #003a75;">
								<spring:message code="label.data.security.page.header" />
							</h3>

							<spring:message code="label.data.security.page.para1" />
							<spring:message code="label.data.security.page.para1.list" />
							...
							<div class="whyusmain">
								<div class="whyusheading">
									<img
										...
										alt="" align="left" />
									<spring:message code="label.data.security.page.subheader1" />
								</div>
								<div class="whyus">
									<spring:message code="label.data.security.page.para2" />
								</div>
							</div>
							<div class="whyusmain">
								<div class="whyusheading">
									<img
										src="${pageContext.request.contextPath}/resources/images/bullet1.jpg"
										alt="" align="left" />
									<spring:message code="label.data.security.page.subheader2" />
								</div>
								<div class="whyus">
									<spring:message code="label.data.security.page.para3" />
									<spring:message code="label.data.security.page.para3list" />
								</div>
								<div class="whyusmain">
									<div class="whyusheading">
										<img
											src="${pageContext.request.contextPath}/resources/images/bullet1.jpg"
											alt="" align="left" />
										<spring:message code="label.data.security.page.subheader3" />
									</div>
									<div class="whyus">
										<spring:message code="label.data.security.page.para4" />
										<spring:message code="label.data.security.page.para4list" />
									</div>
								</div>
								<div class="whyusmain">
									<div class="whyusheading">
										<img
											src="${pageContext.request.contextPath}/resources/images/bullet1.jpg"
											alt="" align="left" />
										<spring:message code="label.data.security.page.subheader4" />
									</div>
									<div class="whyus">
										<spring:message code="label.data.security.page.para5" />
									</div>
								</div>
								<div class="whyusmain">
									<div class="whyusheading">
										<img
											src="${pageContext.request.contextPath}/resources/images/bullet1.jpg"
											alt="" align="left" />
										<spring:message code="label.data.security.page.subheader5" />
									</div>
									<div class="whyus">
										<spring:message code="label.data.security.page.para6" />
										<spring:message code="label.data.security.page.para6list" />
									</div>
								</div>
								<!-- 
