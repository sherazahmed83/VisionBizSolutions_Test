					...
					<td width="720" valign="top" style="padding-right: 10px;">
						<div class="divrightmain">
							<h3 style="color: #003a75;">
								<spring:message code="label.sessionTimeout.page.header" />
							</h3>
							<div class="whyusmain">
								<div class="whyus" style="text-align: left;">
									<spring:message code="label.sessionTimeout.page.para1" />
									<br /> <br />
									<p style="text-align: center;">
										<strong><span class="thankyou"><a
												href="${pageContext.request.contextPath}/loginPage"
												class="thankyou"><spring:message
														code="label.sessionTimeout.page.text.to.login.page" /></a></span></strong>
									</p>
								</div>
							</div>
						</div>
