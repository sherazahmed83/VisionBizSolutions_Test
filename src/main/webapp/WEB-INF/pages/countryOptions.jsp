<select name="country" id="country" style="width: 206px;">
	...
	<option value="Canton and Enderbury Islands">Canton and
	...
	<option value="S. Georgia and S. Sandwich Isls">S. Georgia and
		S. Sandwich Isls.</option>
	...
	<option value="St. Kitts Nevis Anguilla">St. Kitts Nevis
		Anguilla</option>
	...
	<option value="Syran Arab Republic">Syran Arab Republic</option>
	...
	<option value="United States Pacific Islands">United States
	...
	<option value="Virgin Islands, British">Virgin Islands,
		British</option>
	<option value="Virgin Islands, Unites States">Virgin Islands,
		Unites States</option>

	<option value="Wake Island">Wake Island</option>
	<option value="Wallis and Futuma Islands">Wallis and Futuma
		Islands</option>
