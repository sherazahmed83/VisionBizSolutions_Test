					...
					<td width="720" valign="top" style="padding-right: 10px;">
						<div class="divrightmain">
							<h3 style="color: #003a75;">
								<spring:message code="label.support.page.header" />
							</h3>
							<div class="whyusmain">
								<div class="whyus">
									<spring:message code="label.support.page.para1" />
									<br /> <br />
								</div>
							</div>
							...
							<table>
								<tr>
									<td rowspan="5"><img
										src="${pageContext.request.contextPath}/resources/images/customerCare-highRes.jpg"
										alt="" align="left" width="300" /></td>
									<td style="text-align: left;" colspan="2"><spring:message
											code="label.support.page.para2" /></td>
								</tr>
								<tr>
									<td colspan="2"></td>
								</tr>
								<tr>
									<td>
										<div class="whyusmain" style="width: 80px;">
											<div class="whyus">
												<spring:message code="label.support.page.emailus" />
											</div>
										</div>
									</td>
									<td>
										<div class="whyusmain" style="width: 130px">
											<div class="whyus">
												<a style="text-decoration: none;"
													href="<spring:message code="label.support.page.emailus.mailto" />"><spring:message
														code="label.support.page.emailus.value" /></a>
											</div>
										</div>
									</td>
								</tr>
								<tr>
									<td><spring:message code="label.support.page.tollfree" /></td>
									<td><spring:message
											code="label.support.page.tollfree.value" /></td>
								</tr>
								<tr>
									<td><spring:message code="label.support.page.fax" /></td>
									<td><spring:message code="label.support.page.fax.value" /></td>
								</tr>
							</table>
						</div>
					</td>
