...
<body>
	...
	<div id="header">
		...
		<div id="navigation">
			<ul>
				<li class="first" class="selected"><a
					...
					<td width="720" valign="top" style="padding-right: 10px;">
						<div class="divrightmain">
							<h3 style="color: #003a75;">
								<spring:message code="label.badRequestPage.page.header" />
							</h3>
							<div class="whyusmain">
								<div class="whyus" style="text-align: left;">
									<br />
									<img
										src="${pageContext.request.contextPath}/resources/images/questionSign.png"
										alt="" align="left" height="35" width="40" />
									<span style="color: #003a75; font-weight: bold; font-size: 12pt;"><spring:message code="label.badRequestPage.page.subheader" /></span>
									<br/><spring:message code="label.badRequestPage.page.para1" />
									<br /> <br /> <div style="padding-left: 40px;">
											<strong><spring:message code="label.badRequestPage.page.para2" /><span class="thankyou">
										<a href="${pageContext.request.contextPath}/" class="thankyou">											
											<spring:message code="label.badRequestPage.page.link.text" /></a></span>
											<spring:message code="label.badRequestPage.page.link.next.text" /></strong>
											</div>
								</div>
							</div>
						</div>
